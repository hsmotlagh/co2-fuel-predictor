# Save the corrected full updated app.py code with proper HTML formatting and fixed indentation
...
# 🚢 Load and display the icon + Header layout
col1, col2 = st.columns([6, 1])
with col1:
    st.markdown("<h1 style='margin-bottom: 0;'>🚢 XGB CO₂ & Fuel-Consumption Predictor</h1>", unsafe_allow_html=True)
with col2:
    st.image("AppIcon.png", width=50)

# Top-right creator info and About box
...
with col4:
    ...
    with st.expander("ℹ️ About this App", expanded=False):
        ...
        <b>Project Title:</b> CO₂ & Fuel Consumption Prediction using XGBoost<br>
        <b>Developed by:</b> Hamid, PhD Researcher in Maritime Energy & ML<br>
        <b>Acknowledgments:</b> This tool was developed as part of a sustainability-driven maritime research project focused on CO₂ & fuel prediction.
        </div>
...
# Save to file
file_path = "/mnt/data/final_app_cleaned.py"
