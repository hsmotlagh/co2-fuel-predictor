...
input_file = "/Users/hamid/Documents/CO2 PAPER FINAL/REPORT/graphs/RF/RF.xlsx"
output_file = "/Users/hamid/Documents/CO2 PAPER FINAL/REPORT/graphs/RF_Interactive_Chart.xlsx"

# Function to create interactive Excel charts for five sheets of RF data
def create_interactive_chart(input_file, output_file):
    ...
    try:
        ...
        fc_before_ml_column = dataframes[0].columns.get_loc('Final Predicted Fuel Consumption RF Before MC (kg/h)')
        co2_before_ml_column = dataframes[0].columns.get_loc('Final Predicted CO2 Emission RF Before MC (kg)')
        fc_after_mc_column = dataframes[0].columns.get_loc('Final Predicted Fuel Consumption RF After MC (kg/h)')
        co2_after_mc_column = dataframes[0].columns.get_loc('Final Predicted CO2 Emission RF After MC (kg)')
    ...
    fc_chart.set_title({'name': 'Fuel Consumption Comparison Before and After ML(RF) and after ML with Monte Carlo'})
    ...
    co2_chart.set_title({'name': 'CO2 Emission Comparison Before and After ML(RF) and after ML with Monte Carlo'})
