...
input_file = "/Users/hamid/Documents/CO2 PAPER FINAL/REPORT/graphs/SVR/SVR.xlsx"
output_file = "/Users/hamid/Documents/CO2 PAPER FINAL/REPORT/graphs/SVR_Interactive_Chart.xlsx"

# Function to create interactive Excel charts for five sheets of SVR data
def create_interactive_chart(input_file, output_file):
    ...
    try:
        ...
        fc_before_ml_column = dataframes[0].columns.get_loc('Final Predicted Fuel Consumption SVR Before MC (kg/h)')
        co2_before_ml_column = dataframes[0].columns.get_loc('Final Predicted CO2 Emission SVR Before MC (kg)')
        fc_after_mc_column = dataframes[0].columns.get_loc('Final Predicted Fuel Consumption SVR After MC (kg/h)')
        co2_after_mc_column = dataframes[0].columns.get_loc('Final Predicted CO2 Emission SVR After MC (kg)')
    ...
    fc_chart.set_title({'name': 'Fuel Consumption Comparison Before and After ML(SVR) and after ML with Monte Carlo'})
    ...
    co2_chart.set_title({'name': 'CO2 Emission Comparison Before and After ML(SVR) and after ML with Monte Carlo'})
