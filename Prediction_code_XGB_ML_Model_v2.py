...
class PredictionApp:
    def __init__(self, root):
        ...
        # Report display
        self.report_text = tk.Text(self.main_frame, height=5, width=80, font=("Helvetica", 10))
    ...
    def predict(self):
        ...
        self.co2_label.config(text=f"Predicted CO2 (After MC): {pred_fc:.2f} kg")
        ...
        self.ax1.set_title('Fuel Consumption (After MC)', fontsize=10)
        self.ax1.set_xlabel('Ship Speed (knots)', fontsize=10)
        self.ax1.set_ylabel('FC (kg/h)', fontsize=10)
        ...
        self.ax2.set_title('CO2 Emissions (After MC)', fontsize=10)
        self.ax2.set_xlabel('Ship Speed (knots)', fontsize=10)
        self.ax2.set_ylabel('CO2 (kg)', fontsize=10)
        ...
        try:
            with pd.ExcelWriter(output_path, engine='openpyxl', mode='a', if_sheet_exists='replace') as writer:
                ...
                combined_data[[
                    ...
                    'Final Predicted CO2 Emission XGB After MC (kg)', 'Type'
                ]].assign(Type='ML Model (After MC)').to_excel(writer, sheet_name='Model_Predictions', index=False)
