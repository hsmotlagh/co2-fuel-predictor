...
# Define output path
output_path = "/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_3_graphs/Table_D2_GPR.xlsx"

# Data for GPR
data = [
    {'Scenario': 'Original', 'MSE': 34.61564091},
    {'Scenario': 'Paint', 'MSE': 26.65448824},
    {'Scenario': 'Advance Propeller', 'MSE': 858.7625862},
    {'Scenario': 'Fin', 'MSE': 11.53390635},
    {'Scenario': 'Bulbous Bow', 'MSE': 270.8768963},
    {'Scenario': 'Combined', 'MSE': 99.97322306}
]

try:
    workbook = xlsxwriter.Workbook(output_path)
    worksheet = workbook.add_worksheet('GPR')
    ...
    worksheet.merge_range('A1:C1', 'Table D2: GPR Model Performance Metrics for FC After MC', merge_format)
    ...
    worksheet.write(footnote_row + 1, 0, '1. GPR metrics are provided only for FC after MC simulations; CO₂ metrics are unavailable.', cell_format)
    ...
    workbook.close()
    print(f"GPR Table D2 saved to {output_path}")
