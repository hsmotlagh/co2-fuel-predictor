...
# Calculate R² scores
# Original Propeller
predicted_kt_orig = kt_orig_coeff[0] * J**2 + kt_orig_coeff[1] * J + kt_orig_coeff[2]
predicted_kq_orig = kq_orig_coeff[0] * J**2 + kq_orig_coeff[1] * J + kq_orig_coeff[2]
r2_kt_orig = r2_score(original_kt, predicted_kt_orig)
r2_kq_orig = r2_score(original_kq, predicted_kq_orig)

# Advance Propeller
predicted_kt_adv = kt_adv_coeff[0] * J**2 + kt_adv_coeff[1] * J + kt_adv_coeff[2]
predicted_kq_adv = kq_adv_coeff[0] * J**2 + kq_adv_coeff[1] * J + kq_adv_coeff[2]
r2_kt_adv = r2_score(advance_kt, predicted_kt_adv)
r2_kq_adv = r2_score(advance_kq, predicted_kq_adv)

# Print R² scores
print(f"Original Propeller - R² for Kt: {r2_kt_orig:.3f}, R² for Kq: {r2_kq_orig:.3f}")
print(f"Advance Propeller - R² for Kt: {r2_kt_adv:.3f}, R² for Kq: {r2_kq_adv:.3f}")
...
coefficients_data = pd.DataFrame({
    ...
    "Original Kt R²": [r2_kt_orig, "", ""],
    "Original Kq R²": [r2_kq_orig, "", ""],
    "Advance Kt R²": [r2_kt_adv, "", ""],
    "Advance Kq R²": [r2_kq_adv, "", ""]
})
...
plt.grid(True)
plt.savefig("/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_1_graphs/effective_power_vs_speed.svg", format="svg")
plt.show()
...
plt.grid(True)
plt.savefig("/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_1_graphs/total_resistance_vs_speed.svg", format="svg")
plt.show()
...
plt.grid(True)
plt.savefig("/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_1_graphs/thrust_required_vs_speed.svg", format="svg")
plt.show()

# Plot graphs for original propeller
plt.figure()
plt.plot(J, original_kt, marker='o', label="Original Kt")
plt.plot(J, predicted_kt_orig, linestyle='--', label="Original Kt (fit)")
plt.xlabel("Advance Coefficient (J)")
plt.ylabel("Thrust Coefficient (Kt)")
plt.title(f"J vs Kt for Original Propeller (R² = {r2_kt_orig:.3f})")
plt.legend()
plt.grid(True)
plt.text(0.05, 0.95, f'R² = {r2_kt_orig:.3f}', transform=plt.gca().transAxes, fontsize=10, verticalalignment='top')
plt.savefig("/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_1_graphs/original_propeller_J_vs_Kt.svg", format="svg")
plt.show()

plt.figure()
plt.plot(J, original_kq, marker='o', label="Original Kq")
plt.plot(J, predicted_kq_orig, linestyle='--', label="Original Kq (fit)")
plt.xlabel("Advance Coefficient (J)")
plt.ylabel("Torque Coefficient (10*Kq)")
plt.title(f"J vs Kq for Original Propeller (R² = {r2_kq_orig:.3f})")
plt.legend()
plt.grid(True)
plt.text(0.05, 0.95, f'R² = {r2_kq_orig:.3f}', transform=plt.gca().transAxes, fontsize=10, verticalalignment='top')
plt.savefig("/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_1_graphs/original_propeller_J_vs_Kq.svg", format="svg")
plt.show()

# Plot graphs for advance propeller
plt.figure()
plt.plot(J, advance_kt, marker='o', label="Advance Kt")
plt.plot(J, predicted_kt_adv, linestyle='--', label="Advance Kt (fit)")
plt.xlabel("Advance Coefficient (J)")
plt.ylabel("Thrust Coefficient (Kt)")
plt.title(f"J vs Kt for Advance Propeller (R² = {r2_kt_adv:.3f})")
plt.legend()
plt.grid(True)
plt.text(0.05, 0.95, f'R² = {r2_kt_adv:.3f}', transform=plt.gca().transAxes, fontsize=10, verticalalignment='top')
plt.savefig("/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_1_graphs/advance_propeller_J_vs_Kt.svg", format="svg")
plt.show()

plt.figure()
plt.plot(J, advance_kq, marker='o', label="Advance Kq")
plt.plot(J, predicted_kq_adv, linestyle='--', label="Advance Kq (fit)")
plt.xlabel("Advance Coefficient (J)")
plt.ylabel("Torque Coefficient (10*Kq)")
plt.title(f"J vs Kq for Advance Propeller (R² = {r2_kq_adv:.3f})")
plt.legend()
plt.grid(True)
plt.text(0.05, 0.95, f'R² = {r2_kq_adv:.3f}', transform=plt.gca().transAxes, fontsize=10, verticalalignment='top')
plt.savefig("/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_1_graphs/advance_propeller_J_vs_Kq.svg", format="svg")
plt.show()