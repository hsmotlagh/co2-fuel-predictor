...
# ---- Header and Branding ----
# Top row layout with logo/title on the left and icon on the right
...
# Second row for Creator info and slightly wider About box
col3, col4 = st.columns([6, 2])  # <-- changed from [7, 1] to [6, 2] to double width
with col3:
    st.markdown(
