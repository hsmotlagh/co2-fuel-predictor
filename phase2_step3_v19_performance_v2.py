...
# Define output path
output_path = "/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_2_graphs/phase2-step1_performance_analysis_v2.xlsx"
...
with pd.ExcelWriter(output_path, engine='xlsxwriter') as writer:
    ...
    # Pivot data for chart (Scenario vs Speed for each metric)
    ...
    # Clustered column chart for each speed
    ...
    for i, scenario in enumerate(scenarios):
        ...
        # Treq Reduction
        chart.add_series({
            'name': f'{scenario} Treq Reduction',
    ...
    chart.set_title({'name': 'Scenario-Specific Performance Analysis Across Speeds'})
    chart.set_x_axis({'name': 'Ship Speed (knots)'})
    chart.set_y_axis({'name': 'Efficiency Gain (%)', 'major_gridlines': {'visible': True}, 'min': -10, 'max': 15})
