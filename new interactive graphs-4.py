...
input_file = "/Users/hamid/Documents/CO2 PAPER FINAL/REPORT/graphs/XGB/XGB.xlsx"
output_file = "/Users/hamid/Documents/CO2 PAPER FINAL/REPORT/graphs/XGB_Interactive_Chart.xlsx"

# Function to create interactive Excel charts for five sheets of XGB data
def create_interactive_chart(input_file, output_file):
    ...
    try:
        ...
        fc_before_ml_column = dataframes[0].columns.get_loc('Final Predicted Fuel Consumption XGB Before MC (kg/h)')
        co2_before_ml_column = dataframes[0].columns.get_loc('Final Predicted CO2 Emission XGB Before MC (kg)')
        fc_after_mc_column = dataframes[0].columns.get_loc('Final Predicted Fuel Consumption XGB After MC (kg/h)')
        co2_after_mc_column = dataframes[0].columns.get_loc('Final Predicted CO2 Emission XGB After MC (kg)')
    ...
    fc_chart.set_title({'name': 'Fuel Consumption Comparison Before and After ML(XGB) and after ML with Monte Carlo'})
    ...
    co2_chart.set_title({'name': 'CO2 Emission Comparison Before and After ML(XGB) and after ML with Monte Carlo'})
