...
# Define output path
output_path = "/Users/hamid/Documents/CO2 PAPER FINAL/PHASE_3_graphs/Table_D2_RF.xlsx"

# Data for RF
data = [
    {'Scenario': 'Original', 'MSE': 2.726694526},
    {'Scenario': 'Paint', 'MSE': 1.572330678},
    {'Scenario': 'Advance Propeller', 'MSE': 2.350944354},
    {'Scenario': 'Fin', 'MSE': 5.924156541},
    {'Scenario': 'Bulbous Bow', 'MSE': 3.632037997},
    {'Scenario': 'Combined', 'MSE': 1.100682394}
]

try:
    workbook = xlsxwriter.Workbook(output_path)
    worksheet = workbook.add_worksheet('RF')
    ...
    worksheet.merge_range('A1:C1', 'Table D2: RF Model Performance Metrics for FC After MC', merge_format)
    ...
    worksheet.write(footnote_row + 1, 0, '1. RF metrics are provided only for FC after MC simulations; CO₂ metrics are unavailable.', cell_format)
    ...
    workbook.close()
    print(f"RF Table D2 saved to {output_path}")
